...
setwd("~/Documents/SPU Academics /Spring Q 23/Data and Society")
...
#(m5 <- lm(spatialmismatch ~ PC1 + PC2 + City + City*PC1 + City*PC2, data=final3))
...
PrincipalComponent_1 <- c(0.46, 0.23, 0.01, -0.50, -0.37, -0.24, -0.25, -0.07, 0.05, 0.46)
PrincipalComponent_2 <- c(0.43, -0.45, -0.23, -0.36, 0.32, -0.007, 0.07, 0.49, 0.35, -0.14)

Baltimore_PCA_Results<- data.frame(Variables,PrincipalComponent_1, PrincipalComponent_2)
```
